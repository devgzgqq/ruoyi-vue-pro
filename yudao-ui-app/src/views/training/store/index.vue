  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否推荐" prop="recommend">
        <el-select v-model="queryParams.recommend" placeholder="请选择是否推荐" clearable size="small">
          <el-option v-for="dict in this.getDictDatas(DICT_TYPE.INFRA_BOOLEAN_STRING)"
                       :key="dict.value" :label="dict.label" :value="dict.value"/>
        </el-select>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="门店手机号" align="center" prop="mobile" />
      ...
      <el-table-column label="门店图片" align="center" prop="images" />
      <el-table-column label="门店介绍" align="center" prop="introduce" />
