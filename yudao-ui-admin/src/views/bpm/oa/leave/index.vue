<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="申请编号" align="left" prop="id" />
      <el-table-column label="状态" align="left" prop="result">
      ...
      <el-table-column label="请假类型" align="left" prop="type">
        <template v-slot="scope">
          <dict-tag :type="DICT_TYPE.BPM_OA_LEAVE_TYPE" :value="scope.row.type"/>
        </template>
      </el-table-column>
      <el-table-column label="原因" align="left" prop="reason" />
      <el-table-column label="申请时间" align="left" prop="applyTime" width="180">
        <template v-slot="scope">
      ...
      <el-table-column label="操作" align="left" class-name="small-padding fixed-width" width="200">
        <template v-slot="scope">
          <el-button size="mini"type="text" @click="handleCancel(scope.row)"
          ...
          <el-button size="mini" type="text" @click="handleProcessDetail(scope.row)">审批进度</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
