<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="定义编号" align="left" prop="id" width="400" />
      <el-table-column label="定义名称" align="left" prop="name" width="100">
      ...
      <el-table-column label="定义分类" align="left" prop="category" width="100">
        <template v-slot="scope">
      ...
      <el-table-column label="状态" align="left" prop="version" width="80">
        <template v-slot="scope">
      ...
      <el-table-column label="定义描述" align="left" prop="description" width="300" show-overflow-tooltip />
