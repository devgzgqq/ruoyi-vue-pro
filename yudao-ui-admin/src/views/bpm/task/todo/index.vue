<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="任务编号" align="left" prop="id" width="320" />
      <el-table-column label="任务名称" align="left" prop="name" />
      <el-table-column label="所属流程" align="left" prop="processInstance.name" />
      <el-table-column label="流程发起人" align="left" prop="processInstance.startUserNickname" />
