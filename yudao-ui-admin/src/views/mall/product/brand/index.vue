<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="品牌编号" align="left" prop="id"/>
      <el-table-column label="品牌名称" align="left" prop="name"/>
      <el-table-column label="品牌图片" align="left" prop="picUrl">
        <template v-slot="scope">
          <img v-if="scope.row.picUrl" :src="scope.row.picUrl" alt="分类图片" style="height: 100px;" />
        </template>
      </el-table-column>
      <el-table-column label="品牌排序" align="left" prop="sort"/>
      <el-table-column label="品牌描述" align="left" prop="description"/>
