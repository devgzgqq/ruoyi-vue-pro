<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="模板内容" align="left" prop="content" width="300" />
      <el-table-column label="短信类型" align="left" prop="type">
      ...
      <el-table-column label="短信 API 的模板编号" align="left" prop="apiTemplateId" width="180" />
