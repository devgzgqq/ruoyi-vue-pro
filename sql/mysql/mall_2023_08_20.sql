...
-- ----------------------------
BEGIN;
INSERT INTO `member_user` (`id`, `mobile`, `password`, `status`, `register_ip`, `login_ip`, `login_date`, `nickname`, `avatar`, `name`, `sex`, `area_id`, `birthday`, `mark`, `point`, `tag_ids`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (247, '15601691300', '$2a$04$v1VbPLiqh3LckLVbzWZCIOnczkZQ9psE1ozEW88ZKiuDrvHcJFMqC', 0, '127.0.0.1', '127.0.0.1', '2022-07-15 00:59:32', '21土豆', 'http://127.0.0.1:48080/admin-api/infra/file/4/get/fee19466c40aecd32d42e67caed40ef68283cc3bdbdb39f73ec2906ef333f4a1.png', '啦啦啦', 1, 130102, '2023-08-28 00:00:00', '备注3213123', 10, '1,2', NULL, '2022-05-29 11:23:08', '1', '2023-08-20 09:21:31', b'0', 1);
COMMIT;
...
CREATE TABLE `product_comment`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品评论';

-- ----------------------------
-- Records of product_comment
-- ----------------------------
BEGIN;
INSERT INTO `product_comment` (`id`, `user_id`, `user_nickname`, `user_avatar`, `anonymous`, `order_id`, `order_item_id`, `spu_id`, `spu_name`, `sku_id`, `visible`, `scores`, `description_scores`, `benefit_scores`, `content`, `pic_urls`, `reply_status`, `reply_user_id`, `reply_content`, `reply_time`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (1, NULL, NULL, NULL, NULL, NULL, NULL, 633, NULL, NULL, b'1', 4, 3, 4, NULL, NULL, NULL, NULL, NULL, NULL, '', '2023-06-27 15:57:00', '', '2023-06-27 15:59:26', b'0', 1), (2, NULL, NULL, NULL, NULL, NULL, NULL, 633, NULL, NULL, b'1', 1, 3, 4, NULL, NULL, NULL, NULL, NULL, NULL, '', '2023-06-27 15:57:00', '', '2023-06-27 15:59:26', b'0', 1), (3, 247, '', '', b'0', 70, 50, 633, '索尼（SONY）WH-CH510 无线立体声耳机 学生网课 白色', 1, NULL, NULL, 4, 5, '31321', '[]', NULL, NULL, NULL, NULL, '247', '2023-08-13 21:34:48', '247', '2023-08-13 21:34:48', b'0', 1), (4, 247, '', '', b'0', 71, 51, 633, '索尼（SONY）WH-CH510 无线立体声耳机 学生网课 白色', 1, NULL, NULL, 4, 3, '3213123', '[]', NULL, NULL, NULL, NULL, '247', '2023-08-13 21:35:32', '247', '2023-08-13 21:35:32', b'0', 1), (5, 247, '', '', b'0', 72, 52, 633, '索尼（SONY）WH-CH510 无线立体声耳机 学生网课 白色', 1, NULL, NULL, 2, 3, '3123211', '[]', NULL, NULL, NULL, NULL, '247', '2023-08-13 21:41:40', '247', '2023-08-13 21:41:40', b'0', 1), (6, 247, '', '', b'0', 73, 53, 633, '索尼（SONY）WH-CH510 无线立体声耳机 学生网课 白色', 1, NULL, NULL, 4, 4, '13231', '[\"http://127.0.0.1:48080/admin-api/infra/file/4/get/fee19466c40aecd32d42e67caed40ef68283cc3bdbdb39f73ec2906ef333f4a1.png\",\"http://127.0.0.1:48080/admin-api/infra/file/4/get/1fab984924d56504a980c15e2fe3f10c5b19a8939c3577c5736c6600e2dacc08.jpg\"]', NULL, NULL, NULL, NULL, '247', '2023-08-13 22:01:36', '247', '2023-08-13 22:01:36', b'0', 1);
COMMIT;
